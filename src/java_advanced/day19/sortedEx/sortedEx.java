...
public class sortedEx {
    public static void main(String[] args) {
        ...
        //names2 의 이름 중 "D"로 시작하는 이름을 대문자로 모두 바꾸어 , 자연 정렬하여 출력하세요.
        System.out.println(names2.stream().filter(name -> name.startsWith("D")).map(name->name.toUpperCase()).sorted().collect(Collectors.toList()));
